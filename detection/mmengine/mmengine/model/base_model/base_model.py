...
class BaseModel(BaseModule):
    ...
    def train_step(self, epoch: int, data: Union[dict, tuple, list],
                   optim_wrapper: OptimWrapper=None) -> Dict[str, torch.Tensor]:
    ...
    def visualize_gt(self, data,
                    save_path="/home/guoyang/Projects/NEWPAPER/Ablation/SFDNet_Final_Code/tmp.jpg"):
        import cv2
        import torch
        import numpy as np
        # =========================
        ...
        # 2. 获取GT框
        # =========================
        bboxes = data['data_samples'][0]._gt_instances.bboxes.cxcywh
    ...
    def val_step(self, data: Union[tuple, dict, list]) -> list:
        ...
        return self._run_forward(48, data, mode='predict')  # type: ignore
    ...
    def test_step(self, data: Union[dict, tuple, list]) -> list:
        ...
        Returns:
            list: The predictions of given data.
        """
        data = self.data_preprocessor(data, False) #传一个48当成epoch
        return self._run_forward(48, data, mode='predict')  # type: ignore
    ...
    def _run_forward(self, epoch: int, data: Union[dict, tuple, list],
        ...
        if isinstance(data, dict):
            results = self(epoch, **data, mode=mode)
